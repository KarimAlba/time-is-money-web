...
import './style.css';
import RunningMan from "../imgTimeIsMoney/RunningMan.svg"
            ...
            <div className="block1-plugin">
                ...
                <div className="block1-plugin-text1">
                    <p>
                        ...
                        то скачайте наш плагин <span>здесь</span>, если у вас нет лицензионного Word
                        скачайте нашу версию текстового редактора с уже встроенным
                        плагином  <span>здесь</span>.
                        <br />
                        <br />
                        ...
                        оплаты вы можете ознакомиться <span>здесь</span>.
                    </p>
                </div>
            </div>
