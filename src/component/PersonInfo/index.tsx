...
import './style.css';
import ArrowIcon from '../imgTimeIsMoney/arrow-icon.svg'
import DoneIcon from '../imgTimeIsMoney/done-icon.svg'
import ArrowDownIcon from '../imgTimeIsMoney/arrow-down-icon.svg'
